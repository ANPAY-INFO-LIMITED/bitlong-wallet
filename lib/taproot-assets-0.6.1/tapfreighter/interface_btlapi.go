...
type CoinSelector interface {
	...
	// SelectCoinsListEligibleCoins btlapi 调用接口内层实现
	SelectCoinsListEligibleCoins(ctx context.Context, constraints CommitmentConstraints) ([]*AnchoredCommitment, error)

	// SelectCoinsWithFilter btlapi
	SelectCoinsWithFilter(ctx context.Context, constraints CommitmentConstraints, strategy MultiCommitmentSelectStrategy, maxVersion commitment.TapCommitmentVersion, coinsFilter *btlrpc.CoinsFilter) ([]*AnchoredCommitment, error)
}
