...
replace (
	...
	github.com/lightninglabs/faraday => ../wallet/lib/faraday@v0.2.13
	github.com/lightninglabs/lightning-terminal => ../wallet/lib/lightning-terminal@v0.12.2
	github.com/lightninglabs/lnd => ../wallet/lib/lnd@v0.17.4
	github.com/lightninglabs/lndclient => ../wallet/lib/lndclient@v0.17.4
	github.com/lightninglabs/loop => ../wallet/lib/loop@v0.26.6
	github.com/lightninglabs/pool => ../wallet/lib/pool@v0.6.4
	github.com/lightninglabs/taproot-assets => ../wallet/lib/taproot-assets@v0.3.3
